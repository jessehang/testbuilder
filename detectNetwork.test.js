...
describe('Discover', function() {
  ...
  it('has a prefix of 644 and a length of 16', function () {
    detectNetwork('6446492345678912').should.equal('Discover')
  });
  it('has a prefix of 644 and a length of 19', function () {
    detectNetwork('6446492345678912345').should.equal('Discover')
  });
  it('has a prefix of 645 and a length of 16', function () {
    detectNetwork('6456492345678912').should.equal('Discover')
  });
  it('has a prefix of 645 and a length of 19', function () {
    detectNetwork('6456492345678912345').should.equal('Discover')
  });
  it('has a prefix of 646 and a length of 16', function () {
    detectNetwork('6466492345678912').should.equal('Discover')
  });
  it('has a prefix of 646 and a length of 19', function () {
    detectNetwork('6466492345678912345').should.equal('Discover')
  });
  it('has a prefix of 647 and a length of 16', function () {
    detectNetwork('6476492345678912').should.equal('Discover')
  });
  it('has a prefix of 647 and a length of 19', function () {
    detectNetwork('6476492345678912345').should.equal('Discover')
  });
  it('has a prefix of 648 and a length of 16', function () {
    detectNetwork('6486492345678912').should.equal('Discover')
  });
  it('has a prefix of 648 and a length of 19', function () {
    detectNetwork('6486492345678912345').should.equal('Discover')
  });
  it('has a prefix of 649 and a length of 16', function () {
    detectNetwork('6496492345678912').should.equal('Discover')
  });
  it('has a prefix of 649 and a length of 19', function () {
    detectNetwork('6496492345678912345').should.equal('Discover')
  });
...
describe('should support China UnionPay', function() {
  ...
  let testCase = function (prefix, size, network) {
    it(`has a prefix of ${prefix} and a length of ${size}`, function () {
      detectNetwork(network).should.equal('China UnionPay')
    });
  }

  for (let i = 622126; i <= 622925; i++) {
    for (let j = 16; j <= 19; j++) {
      network = String(i).padEnd(j, '0');
      testCase(i, j, network);
    }
  }
...
describe('should support Switch', function() {
  ...
  let testCase = function(prefix, size, network) {
    it(`has a prefix of ${prefix} and a length of ${size}`, function () {
      detectNetwork(network).should.equal('Switch')
    });
  }

  for (let i = 0; i < prefix.length; i++) {
    for (let j = 0; j < sizes.length; j++) {
      let network = String(prefix[i]).padEnd(sizes[j], '0')
      testCase(prefix[i], sizes[j], network);
    }
  }
